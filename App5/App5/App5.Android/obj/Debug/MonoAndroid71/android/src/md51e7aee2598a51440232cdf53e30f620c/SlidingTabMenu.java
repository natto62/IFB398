...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MiCareApp.Droid.SlidingTabMenu, MiCareApp.Android", SlidingTabMenu.class, __md_methods);
	}
	...
	public SlidingTabMenu (android.support.v4.app.FragmentManager p0)
	{
		...
		if (getClass () == SlidingTabMenu.class)
			mono.android.TypeManager.Activate ("MiCareApp.Droid.SlidingTabMenu, MiCareApp.Android", "Android.Support.V4.App.FragmentManager, Xamarin.Android.Support.Fragment", this, new java.lang.Object[] { p0 });
	}
