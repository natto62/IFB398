...
namespace MiCareDBapp.Droid
{
    ...
    public class SlidingTabOccupancy : FragmentActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            //list of strings to use for the sliding tab interface, these are the titles of the different occupancy kpi's each with their own fragment
            ...
            //sets the layout of the main menu to the ViewPagerOccupancy.axml file which is located in Resources/layout/
