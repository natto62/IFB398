...
namespace MiCareDBapp.Droid
{
    ...
    public class StaffPage : Android.Support.V4.App.Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            //sets the layout of the main menu to the StaffPage.axml file which is located in Resources/layout/
            View view = inflater.Inflate(Resource.Layout.StaffPage, container, false);

            //setup lists for staff data
            dataItems = new List<StaffData>();
            displayItems = new List<StaffData>();
            searchItems = new List<StaffData>();

            //setup custom list adapter, more info found in StaffViewAdapter.cs
            ...
            SearchItems.QueryTextSubmit += delegate {
                ...
                foreach (StaffData item in searchItems) {
                    ...
                    bool insideNameUpper = item.GetStaffFirstName().Contains(searchNameUpper) || item.GetStaffLastName().Contains(searchNameUpper);
            ...
            RefreshBtn.Click += delegate {
                ...
                //call php file and use UploadValuesAsync with the value of Type=Staff so the php file knows to pull staff data
            ...
            client.UploadValuesCompleted += delegate (object sender, UploadValuesCompletedEventArgs e) {
                Activity.RunOnUiThread(() => {
                    ...
                    dataItems = JsonConvert.DeserializeObject<List<StaffData>>(json);//use json to create a list of data objects from the output of the php file
                    adapter = new StaffViewAdapter(this.Context, dataItems);//setup adapter
                    foreach (StaffData item in dataItems) {
